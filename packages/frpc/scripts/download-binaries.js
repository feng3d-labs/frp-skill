...
const PLATFORMS = [
  { name: 'linux-x64', platform: 'linux', arch: 'amd64', ext: 'tar.gz', pkgDir: 'frpc-linux-x64', binary: 'frpc' },
  { name: 'linux-arm64', platform: 'linux', arch: 'arm64', ext: 'tar.gz', pkgDir: 'frpc-linux-arm64', binary: 'frpc' },
  { name: 'win32-x64', platform: 'windows', arch: 'amd64', ext: 'zip', pkgDir: 'frpc-win32-x64', binary: 'frpc.exe' },
  { name: 'darwin-x64', platform: 'darwin', arch: 'amd64', ext: 'tar.gz', pkgDir: 'frpc-darwin-x64', binary: 'frpc' },
  { name: 'darwin-arm64', platform: 'darwin', arch: 'arm64', ext: 'tar.gz', pkgDir: 'frpc-darwin-arm64', binary: 'frpc' },
];
